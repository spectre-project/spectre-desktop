...
class SpectreInterface {
    ...
    async main() {
        ...
        const methods = proto.SpectredMessage.type.field
        ...
        program
            ...
            .description(`Spectre gRPC client ${pkg.version}`)
...
Please run ${'spectre-rpc help'.yellow} for addition information and examples.        
        `)
        ...
        program
            ...
            .action(async (cmd, options) => {
                ...
                console.log('');
                console.log(`Spectre gRPC client ${pkg.version}`);
                console.log('');
...
Examples:
    ...
    $ ${`rpc --verbose getUtxosByAddresses --addresses=[\\"spectretest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u\\"]`.yellow}
    ...
    Where file.js can contain: ${`{ addresses : ['spectretest:qru9nrs0mjcrfnl7rpxhhe33l3sxzgrc3ypkvkx57u'] }`.yellow}
